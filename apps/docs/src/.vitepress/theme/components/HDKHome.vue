  ...
  <main>
    <div class="container">
      ...
      <div class="screenshot">
        <img src="/screenshot_library_dark.webp" alt="Comicers screenshot (dark)" class="dark-only" />
        <img src="/screenshot_library_light.webp" alt="Comicers screenshot (light)" class="light-only" />
        <div />
      </div>
    </div>
  </main>
