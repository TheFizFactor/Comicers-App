...
import { CheckCheck, ListIcon, Play, Pointer, Tags, Trash2 } from 'lucide-react';
  ...
  return (
    <>
      <ContextMenuContent className="w-48">
        ...
        <ContextMenuItem onClick={() => setShowingReadingLists(true)}>
        ...
        <ContextMenuItem onClick={removeFunc}>
          ...
          {props.removeActionText || 'Remove series'}
        </ContextMenuItem>
      </ContextMenuContent>
      {props.series && (
        <ReadingListsDialog
          series={props.series}
          showing={showingReadingLists}
          setShowing={setShowingReadingLists}
        />
      )}
    </>
  );
