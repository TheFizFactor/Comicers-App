...
import { Category, ImportTask, ReadingList, TableColumnSortOrder } from '@/common/models/types';
import {
...
export const readingListsState = atom<ReadingList[]>({
  key: 'readingListsState',
  default: [],
});

export const activeReadingListState = atom<ReadingList | null>({
  key: 'activeReadingListState',
  default: null,
});
