...
import { TooltipContent } from '@comicers/ui/components/Tooltip';
type SidebarContext = {
...
declare const SidebarTrigger: React.ForwardRefExoticComponent<Omit<import("@comicers/ui/components/Button").ButtonProps & React.RefAttributes<HTMLButtonElement>, "ref"> & React.RefAttributes<HTMLButtonElement>>;
