...
const SidebarRail = React.forwardRef(({ className, ...props }, ref) => {
    const { toggleSidebar } = useSidebar();
    return (_jsx("button", { ref: ref, "data-sidebar": "rail", "aria-label": "Toggle Sidebar", tabIndex: -1, onClick: toggleSidebar, title: "Toggle Sidebar (Ctrl/Cmd + B)", className: cn(
        ...
        'hover:after:w-[4px] hover:after:bg-sidebar-accent transition-all duration-200',
        className), ...props }));
});
